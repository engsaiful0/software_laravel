<div class="modal-dialog" role="document">
  <div class="modal-content">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @else
                {!! Form::text("amount", @num_format($ob_due), ['class' => 'form-control input_number payment_amount', 'required', 'placeholder' => __('sale.amount')]); !!}
              @endif
            </div>
          </div>
        </div>
    ...
    <div class="modal-footer">
      @if($ob_due==0)
        <button disabled type="submit" class="btn btn-primary">@lang( 'messages.save' )</button>
      @elseif($ob_due>0)
