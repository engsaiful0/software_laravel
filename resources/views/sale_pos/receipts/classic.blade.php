...
<div class="row" style="color: #000000 !important;">
	...
	<div class="col-xs-12 text-center">
		...
		<p style="width: 100% !important" class="word-wrap">
			<span style="width:60%" class="pull-left text-left word-wrap">
			...
			<span style="width:40%" class="pull-right text-left">
		...
		<table class="table table-responsive table-slim">
			<thead>
				<tr>
					...
					<th class="text-right" width="5%">Unit</th>
		...
		<div class="table-responsive">
			<table class="table table-slim">
				<tbody>
					...
					<tr>
						<td colspan="2" class="text-left;margin-top:30px">
							@if(!empty($receipt_details->total_in_words))
							<b>In Word: {{$receipt_details->total_in_words}} Taka Only</b>
							@endif
						</td>
					</tr>
				</tbody>
